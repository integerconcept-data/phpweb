          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              <div>
                ...
                <?php else :?>
                  <a href="/register" class="<?= urlIs('/register.php') ? 'bg-gray-900 text-white' : 'text-gray-300'?> hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Register</a>
                  <a href="/login" class="<?= urlIs('/login.php') ? 'bg-gray-900 text-white' : 'text-gray-300'?> hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Login</a>
                <?php endif; ?>
              </div>
